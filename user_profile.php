						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active"><?php echo $data['name'];?> Profile</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
									...
									<div class="col-auto profile-image">
											<?php 
												if ($data['photo'] =='') {
													# code...
											?>
											<img class="rounded-circle img-lg" alt="User Image" src="images/FILE223.PNG">
											<?php
												}else {
													# code...
											?>
											<img class="rounded-circle img-lg" alt="User Image" src="user_image/<?php echo $data['photo'];?>">
											<?php }?>
									</div>
									
									<div class="col ml-md-n2 profile-user-info">
										<h4 class="user-name mb-0"><?php echo $data['name'];?> <?php echo $data['lastname'];?></h4>
							...
							<div class="profile-menu">
								<ul class="nav nav-tabs nav-tabs-solid">
									<li class="nav-item">
										<a class="nav-link active" data-toggle="tab">Personal Details</a>
									</li>
								</ul>
							</div>	
										...
										<div class="col-lg-12">
											<div class="card mt-0">
												<div class="card-body">
                                					...
                                					<tr>
                                                		<td>
                                  							<strong>Full Name :</strong> <?php echo $data['name'];?>  <?php echo $data['lastname'];?>
														</td>
														
                                    
                                					
                                  						<td>
								                  			<strong>Username :</strong> <?php echo $data['username'];?>
														</td>
                                              		...
                                              		<tr>
													  	...
													  	<td>
															...
															if($data['role']==0) echo"Admin";elseif($data['role']==1) echo"Librarian";?>
