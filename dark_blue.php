                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="vendors/assets/img/Majeed.jpg" alt="card image">
                                    </p>
                                    <h4 class="card-title">Abdul Majeed Sediqi</h4>
                                    <p class="card-text">Project Manager and CEO of DarkBlue Development Company</p><br>
                                    <a href="dark_blue.php" class="btn btn-primary btn-sm"><i class="fa fa-desktop"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="vendors/assets/img/Murtaza.jpg" alt="card image">
                                    </p>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="vendors/assets/img/sediq.jpg" alt="card image"></p>
                                    <h4 class="card-title">Baharan Popal</h4>
                                    <p class="card-text">A member of DarkBlue Development Company
                                    </p><br>
                                    <a href="" class="btn btn-primary btn-sm"><i class="fa fa-desktop"></i></a>
                                </div>
