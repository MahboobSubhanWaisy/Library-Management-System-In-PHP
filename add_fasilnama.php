...
if (isset($_POST['fasilnama_update'])) {
    $fasilnama_id = $_POST['fasilnama_id'];
     ...
     $b_c_id = $_POST['b_c_id'];
         ...
         $query_edit = "UPDATE `fasilnama` SET `fasilnama_title`='$fasilnama_title',`fasilnama_subject`='$fasilnama_subject',`author`='$author',`publish_year`='$publish_year',`fas_info`='$fas_info',`publish_place`='$publish_place',`fas_number`='$fas_number',`b_c_id`='$b_c_id',`copy`='$copy' WHERE fasilnama_id = '$fasilnama_id'";
