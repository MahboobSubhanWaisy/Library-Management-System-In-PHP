...
<div class="bg-white col-12 p-4" style="min-height:60vh; margin-bottom:70px; margin-top:20px; border:1px solid #eee; border-radius:6px;" id="b">
    <div class="col-12 p-4" style="border-radius:6px; background-color:#f9fbfd">
        <p class="mdi mdi-book-open-page-variant" style="font-size:1rem;">Lon & Return Book</p>
            ...
            <form action="" method="post" class="loan-form" enctype="multipart/form-data">
                ...
                <div class="col-md-12 form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control stu-id" name="student-id" placeholder="Type Student ID Here To Search" style="height:40px;">
                                <button type="button" class="btn btn-primary student-search"><span class="mdi mdi-magnify"></span></button>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        $('.loan-section-select').change(function(){
            ...
            if(section_value == 'book'){
                $('.book').show();
                $('.loan-form').attr('action', 'add_lon_return_insert_code.php');
                $('.book-name').val(section_value);
            }else if(section_value == 'fasilnama'){
                $('.loan-form').attr('action', 'add_lon_fasilnama_insert_code.php');
                $('.book-name').val(section_value);
            }
            else if(section_value == 'general'){
                $('.loan-form').attr('action', 'add_general_insert_code.php');
                $('.book-name').val(section_value);
            }else if(section_value == 'rule'){
                $('.loan-form').attr('action', 'add_lon_rule_insert_code.php');
                $('.book-name').val(section_value);
            }else if(section_value == 'monograph'){
                $('.loan-form').attr('action', 'add_lon_monograph_insert_code.php');
                $('.book-name').val(section_value);
            
            }else if(section_value == 'history'){
                $('.loan-form').attr('action', 'add_lon_history_insert_code.php');
                $('.book-name').val(section_value);
            }
        });
